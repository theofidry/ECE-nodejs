...
module.exports = function (globals, path) {
    ...
    return {
        ...
        users: {
             ...
             *
             * @param {string} username
             * @param user {Object} User object: must have the attributes name, email and password. Other attributes may be included as long as it's not a object or a function.
             * @param {Function} callback
             * @returns {*}
             */
